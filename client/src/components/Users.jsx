...
const Users = () => {
  ...
  useEffect(() => {
    axios
      .get("https://crud-api-ochre.vercel.app")
  ...
  const handleDelete = (id) => {
    axios
      .delete(`https://crud-api-ochre.vercel.app/deleteUser/${id}`)
      .then((res) => {
        console.log(res);
  ...
  return (
    <div className="min-h-screen mx-auto flex items-center justify-center flex-col bg-blue-950">
      <h2 className="font-bold text-4xl my-8 text-white">
                ...
                <td className="border px-4 py-4 text-center">
                  <div className="flex justify-center space-x-8">
                    <Link
                      ...
                      className="bg-blue-950 text-white py-1 px-3 rounded"
                    >
                      Update
                    </Link>
                    <button
